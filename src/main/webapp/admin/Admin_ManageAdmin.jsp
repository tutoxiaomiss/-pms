...
<form method="post" action="deleteByIdsAdmin" onsubmit="return del()">
    ...
    <div class="padding border-bottom">
      <ul class="search">
        <li> <a class="button border-main icon-plus-square-o" href="${pageContext.request.contextPath}/goAddAdmin"> 添加内容</a> </li>
        <li>
			...
			<c:forEach items="${page.records}" var="c" varStatus="vs">
				<tr>
					...
					<td>
						...
						<a class="button border-green" href="/findOneAdmin?&id=${c.id}">修改</a>
						</div>
						<div class="button-group">
