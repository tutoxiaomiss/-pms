...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-key"></span> 修改新闻</strong></div>
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${pageContext.request.contextPath}/updateNews">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="title" value="${news.title}" size="50" placeholder="请输入新闻标题" data-validate="required:请输入新闻标题" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea id="content" name="content" style="width: 80%; height: 450px; visibility: hidden;">${news.content}</textarea>
        ...
        <div class="field">
          <input name="author" type="text" value="${news.author}" class="input w50" id="author" placeholder="请输入发布作者" size="50" data-validate="required:请输入发布作者" />
